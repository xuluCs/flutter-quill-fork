    ...
    if (attrs.containsKey(Attribute.header.key)) {
      ...
      switch (level) {
        ...
        case 3:
          ...
          break;
        case 4:
          top = defaultStyles!.h4!.verticalSpacing.item1;
          bottom = defaultStyles.h4!.verticalSpacing.item2;
          break;
        case 5:
          top = defaultStyles!.h5!.verticalSpacing.item1;
          bottom = defaultStyles.h5!.verticalSpacing.item2;
          break;
        case 6:
          top = defaultStyles!.h6!.verticalSpacing.item1;
          bottom = defaultStyles.h6!.verticalSpacing.item2;
          break;
        default:
...
class RenderEditableTextBlock extends RenderEditableContainerBox implements RenderEditableBox {
  ...
  TextSelectionPoint getBaseEndpointForSelection(TextSelection selection) {
    if (selection.isCollapsed) {
      return TextSelectionPoint(Offset(0, preferredLineHeight(selection.extent)) + getOffsetForCaret(selection.extent), null);
    }
  ...
  TextSelectionPoint getExtentEndpointForSelection(TextSelection selection) {
    ...
    final extentPoint = extentChild!.getExtentEndpointForSelection(localSelection(extentChild.container, selection, true));
    return TextSelectionPoint(extentPoint.point + (extentChild.parentData as BoxParentData).offset, extentPoint.direction);
  }
